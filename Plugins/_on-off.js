...
const handler = async (m, { conn, usedPrefix, command, args, isOwner, isAdmin, isROwner }) => {
  ...
  chat[type] = isEnable;
    ...
    conn.reply(m.chat, `⚡ *🤖🌕YᗩᘜIᖇᗩ-ᗷOT-ᗰᗪ🌕🤖*\n━━━━━━━━━━━━━━━━━━━━\n🤖 La función *${type}* ha sido\n${isEnable ? '🌕 *ACTIVADA*' : '😴 *DESACTIVADA*'} ${isAll ? 'para todo el bot 🔧' : isUser ? 'para este usuario 🎒' : 'en este grupo 🕹️🕹️'}\n━━━━━━━━━━━━━━━━━━━━`, m, rcanal); 
};
